...
public class FtaConditionalEvent extends FtaBasicEvent {

    public FtaConditionalEvent(Long failureEntityId, String ftaBlockId, boolean isExpression, ExpressionType expressionType, double value) {
    ...
    public String convert() {
        ...
        xml.append("<attribute name=\"flavor\" value=\"conditional\"/>\n");
        xml.append("</attributes>\n");
