...
//    public static final TenantId SYSTEM_TENANT = new TenantId(ModelConstants.NULL_UUID);
     ...
     * PHM S.Zeniuk
     */
    public static final String BUILDERSCHEMA_COLUMN_FAMILY_NAME="builder_schema";
    public static final String FTA_COLUMN_FAMILY_NAME = "fta";
    //    public static final String FTA_ID_PROPERTY = "rule_chain_id";
    //    public static final String RULE_NODE_TYPE_PROPERTY = "type";
    public static final String FTA_NAME_PROPERTY = "name";
    public static final String FTA_DESCRIPTION_PROPERTY = "description";
    public static final String FTA_BODY_PROPERTY = "body";
    public static final String PHMPICTURES_COLUMN_FAMILY_NAME="pictures";
